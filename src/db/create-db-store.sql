...
CREATE TABLE `orders`(
    ...
    CONSTRAINT `fk_orders_customers_idx` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON UPDATE CASCADE,
    CONSTRAINT `fk_orders_shippers_idx` FOREIGN KEY (`shipper_id`) REFERENCES `shippers` (`shipper_id`) ON UPDATE CASCADE,
    CONSTRAINT `fk_orders_order_statuses_idx` FOREIGN KEY (`status`) REFERENCES `order_statuses` (`order_status_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=11 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `order_items`(
    ...
    CONSTRAINT `fk_order_items_orders_idx` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON UPDATE CASCADE,
    CONSTRAINT `fk_order_items_products_idx` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
